function getElement() {
    ...
    var neilHole = 3.6;
    var filamentHolderDiameter = 14;
    var filamentWidthSafeDistance = 4;
    ...
    var layers = (new Layers())
        ...
        .from(0)
        .thick(filamentWidth - filamentWidthSafeDistance)
        .add(getCircle(filamentHolderDiameter/2, [0,0]))
        .remove(getCircle(neilHole/2, [0,0]))
